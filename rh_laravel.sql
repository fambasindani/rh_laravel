...
-- Listage de la structure de la base pour rh_laravel
CREATE DATABASE IF NOT EXISTS `rh_laravel` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `rh_laravel`;

-- Listage de la structure de table rh_laravel. absences
...
-- Listage des données de la table rh_laravel.absences : ~0 rows (environ)

-- Listage de la structure de table rh_laravel. affectations
...
-- Listage des données de la table rh_laravel.affectations : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. affiliations
...
-- Listage des données de la table rh_laravel.affiliations : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. agents
...
-- Listage des données de la table rh_laravel.agents : ~4 rows (environ)
...
-- Listage de la structure de table rh_laravel. agent_formations
...
-- Listage des données de la table rh_laravel.agent_formations : ~1 rows (environ)
...
-- Listage de la structure de table rh_laravel. conges
...
-- Listage des données de la table rh_laravel.conges : ~1 rows (environ)
...
-- Listage de la structure de table rh_laravel. contrats
...
-- Listage des données de la table rh_laravel.contrats : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. directions
...
-- Listage des données de la table rh_laravel.directions : ~3 rows (environ)
...
-- Listage de la structure de table rh_laravel. documents
...
-- Listage des données de la table rh_laravel.documents : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. droits
...
-- Listage des données de la table rh_laravel.droits : ~47 rows (environ)
...
-- Listage de la structure de table rh_laravel. etudes
...
-- Listage des données de la table rh_laravel.etudes : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. evaluations
...
-- Listage des données de la table rh_laravel.evaluations : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. fonctions
...
-- Listage des données de la table rh_laravel.fonctions : ~5 rows (environ)
...
-- Listage de la structure de table rh_laravel. formations
...
-- Listage des données de la table rh_laravel.formations : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. grades
...
-- Listage des données de la table rh_laravel.grades : ~5 rows (environ)
...
-- Listage de la structure de table rh_laravel. historiques_connexions
...
-- Listage des données de la table rh_laravel.historiques_connexions : ~0 rows (environ)

-- Listage de la structure de table rh_laravel. horaires_travail
...
-- Listage des données de la table rh_laravel.horaires_travail : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. jours_feries
...
-- Listage des données de la table rh_laravel.jours_feries : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. logs
...
-- Listage des données de la table rh_laravel.logs : ~50 rows (environ)
...
-- Listage de la structure de table rh_laravel. migrations
...
-- Listage des données de la table rh_laravel.migrations : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. missions
...
-- Listage des données de la table rh_laravel.missions : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. notifications
...
-- Listage des données de la table rh_laravel.notifications : ~1 rows (environ)
...
-- Listage de la structure de table rh_laravel. permissions
...
-- Listage des données de la table rh_laravel.permissions : ~1 rows (environ)
...
-- Listage de la structure de table rh_laravel. personal_access_tokens
...
-- Listage des données de la table rh_laravel.personal_access_tokens : ~12 rows (environ)
...
-- Listage de la structure de table rh_laravel. pointages
...
-- Listage des données de la table rh_laravel.pointages : ~2 rows (environ)
...
-- Listage de la structure de table rh_laravel. presences
...
-- Listage des données de la table rh_laravel.presences : ~0 rows (environ)

-- Listage de la structure de table rh_laravel. primes
...
-- Listage des données de la table rh_laravel.primes : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. promotions
...
-- Listage des données de la table rh_laravel.promotions : ~0 rows (environ)
...
-- Listage de la structure de table rh_laravel. retraites
...
-- Listage des données de la table rh_laravel.retraites : ~1 rows (environ)
...
-- Listage de la structure de table rh_laravel. roles
...
-- Listage des données de la table rh_laravel.roles : ~3 rows (environ)
...
-- Listage de la structure de table rh_laravel. role_droits
...
-- Listage des données de la table rh_laravel.role_droits : ~55 rows (environ)
...
-- Listage de la structure de table rh_laravel. sanctions
...
-- Listage des données de la table rh_laravel.sanctions : ~1 rows (environ)
...
-- Listage de la structure de table rh_laravel. types_conges
...
-- Listage des données de la table rh_laravel.types_conges : ~5 rows (environ)
...
-- Listage de la structure de table rh_laravel. type_conges
...
-- Listage des données de la table rh_laravel.type_conges : ~5 rows (environ)
...
-- Listage de la structure de table rh_laravel. users
...
-- Listage des données de la table rh_laravel.users : ~3 rows (environ)
...
-- Listage de la structure de table rh_laravel. user_roles
...
-- Listage des données de la table rh_laravel.user_roles : ~3 rows (environ)
...
-- Listage de la structure de table rh_laravel. zones_travail
...
-- Listage des données de la table rh_laravel.zones_travail : ~0 rows (environ)
